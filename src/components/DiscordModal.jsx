...
// Asegúrate de actualizar el nombre del archivo CSS también si lo deseas
import './DiscordModal.css'; 

// Mantengo tu enlace de invitación a Discord
...
export default function DiscordModal({ show, onClose }) {
  ...
  return (
    <div className="discord-modal-bg">
      {/* He mantenido tus clases originales "telegram-modal-content premium-anime" 
          por si tienes animaciones CSS ligadas a ellas, pero lo ideal sería renombrarlas */}
      <div className="discord-modal-content premium-anime" style={{padding:'2.5rem 2rem', minWidth:'320px', position:'relative', textAlign: 'center'}}>
        ...
        {/* BOTÓN DE INVITACIÓN (Color Discord) */}
        <a 
          href={DISCORD_LINK} 
          target="_blank" 
          ...
          style={{
            ...
            borderRadius:'8px',
            // Color 'Blurple' oficial de Discord
            background:'#5865F2', 
            color:'#fff',
            fontWeight:600,
          ...
          // Efecto hover simple mediante JS inline (lo ideal es hacerlo en el CSS)
